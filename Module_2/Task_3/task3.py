...
print("Outputs")
print("Horizontal mag field")
print(math.sqrt((mag_data_X_mean**2 + mag_data_Y_mean **2)))
print("Vertical Mag field")
print(mag_data_Z_mean)
print("Total magnetic field")
print(math.sqrt((mag_data_X_mean**2 + mag_data_Y_mean **2 + mag_data_Z_mean ** 2  )))
